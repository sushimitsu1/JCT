      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-auto p-6">
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            {[
              { label: 'Total Clients', value: '0', color: 'blue' },
              { label: 'Active SKUs', value: '0', color: 'green' },
              { label: 'Open Orders', value: '0', color: 'yellow' },
              { label: 'Monthly Revenue', value: '$0', color: 'purple' },
            ].map((card) => (
